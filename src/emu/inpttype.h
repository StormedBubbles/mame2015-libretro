...
void construct_core_types_P1(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, START,               "P1 Start",               input_seq(JOYCODE_START_INDEXED(0), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(0)) )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SELECT,              "P1 Select",              input_seq(JOYCODE_SELECT_INDEXED(0), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(0)) )
}
...
void construct_core_types_P2(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, START,               "P2 Start",               input_seq(JOYCODE_START_INDEXED(1), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(1)) )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SELECT,              "P2 Select",              input_seq(JOYCODE_SELECT_INDEXED(1), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(1)) )
}
...
void construct_core_types_P3(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, START,               "P3 Start",               input_seq(JOYCODE_START_INDEXED(2), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(2)) )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, SELECT,              "P3 Select",              input_seq(JOYCODE_SELECT_INDEXED(2), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(2)) )
}
...
void construct_core_types_P4(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, START,               "P4 Start",               input_seq(JOYCODE_START_INDEXED(3), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(3)) )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, SELECT,              "P4 Select",              input_seq(JOYCODE_SELECT_INDEXED(3), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(3)) )
}
...
{
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START1,              "1 Player Start",         input_seq(JOYCODE_START_INDEXED(0), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(0)) )
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START2,              "2 Players Start",        input_seq(JOYCODE_START_INDEXED(1), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(1)) )
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START3,              "3 Players Start",        input_seq(JOYCODE_START_INDEXED(2), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(2)) )
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START4,              "4 Players Start",        input_seq(JOYCODE_START_INDEXED(3), input_seq::or_code, GUNCODE_BUTTON6_INDEXED(3)) )
...
{
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN1,               "Coin 1",                 input_seq(JOYCODE_SELECT_INDEXED(0), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(0)) )
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN2,               "Coin 2",                 input_seq(JOYCODE_SELECT_INDEXED(1), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(1)) )
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN3,               "Coin 3",                 input_seq(JOYCODE_SELECT_INDEXED(2), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(2)) )
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN4,               "Coin 4",                 input_seq(JOYCODE_SELECT_INDEXED(3), input_seq::or_code, GUNCODE_BUTTON5_INDEXED(3)) )
