...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_JOYSTICK_DEADZONE ";joy_deadzone;jdz",      "0",         OPTION_FLOAT,      "center deadzone range for joystick where change is ignored (0.0 center, 1.0 end)" },
	{ OPTION_JOYSTICK_SATURATION ";joy_saturation;jsat", "1",         OPTION_FLOAT,      "end of axis saturation range for joystick where change is ignored (0.0 center, 1.0 end)" },
