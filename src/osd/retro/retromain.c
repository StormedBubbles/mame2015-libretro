...
void process_lightgun_state(void)
{
   ...
   for(i = 0;i < 4; i++)
   {
      ...
      lightgunLX[0] = (lightgun_x[0]*2.25) * 2.1;
      lightgunLY[0] = (lightgun_y[0]*2.38) * 2.13;

      lightgunLX[1] = (lightgun_x[1]*2.25) * 2.1;
      lightgunLY[1] = (lightgun_y[1]*2.38) * 2.13;

      //lightgunLX[0] = (lightgun_x[0]*2.25 + 7908) * 2.3649 - 101978;
      //lightgunLY[0] = (lightgun_y[0]*2.38 + 14563) * 2.5424 - 164801;

      //lightgunLX[1] = (lightgun_x[1]*2.25 + 7908) * 2.3649 + 125225;
